...
export const ITEM_DEFINITIONS = {
  ...
  lollipop: {
    ...
    description: 'A sweet gift. Kids love it! They can be found in ` daily `, ` beg `, ` ship `, and during Kasiko server events.',
    source: ["daily",
      "beg",
      "ship"],
    useable: false,
  ...
  teddy: {
    ...
    description: 'A soft and cuddly toy. Can be gifted or sold. They can be found in ` beg `, ` dungeon `, ` ship `, and during Kasiko server events.',
    source: ["dungeon",
      "beg",
      "ship"],
    useable: false,
