...
export default {
  ...
  aliases: [],
  args: "<amount> [userId]",
  example: ["withdraw 5000", "withdraw 5000 123456789012345678"],
  emoji: "🏦",
  cooldown: 10000,
  category: "🧑🏻‍💻 Owner",
  execute: async (args, message) => {
    ...
    if (args[2]) {
      ...
      try {
        await updateUser(recipientId, { cash: recipientData.cash });
      ...
      try {
        await updateUser(message.author.id, { cash: userData.cash });
