import { Ship } from '../shipsHandler.js';
...
function assignSpecialAbility() {
  const abilities = ['Double Attack', 'Heal', 'Shield'];
...
export function createRandomPlayer(player) {
  const usernames = [
    "stormriderkbot", "pixelwarriorkbot", "shadowhunterkbot", "lunareclipsekbot",
    "novatitankbot", "echoknightkbot", "crimsonviperkbot", "solarflarekbot",
    "nebulaxkbot", "silentreaperkbot", "phoenixstrikekbot", "ironcladkbot",
    "gladiatorxkbot", "thunderwolfkbot", "mysticknightkbot", "silverfangkbot",
    "darkphoenixkbot", "vortexmasterkbot", "ghostriderkbot", "frosttitankbot",
    "alphawolfkbot", "shadowdragonkbot", "moonlightwolfkbot", "steelvanguardkbot",
    "blazephoenixkbot", "electricacekbot", "stormchaserkbot", "wraithknightkbot",
    "radiantflarekbot", "ironsoulkbot", "omegabladekbot", "darkstormkbot",
    "crystalshardkbot", "emberphoenixkbot", "viperkingkbot", "moonshadowkbot",
    "fireeaglekbot", "stormbreakerkbot", "frozenshadowkbot", "infernoknightkbot",
    "titanfurykbot", "spectraldragonkbot", "rogueacekbot", "phantomwardenkbot",
    "lunarrangerkbot", "mysticfalconkbot", "abysswalkerkbot", "chaosknightkbot",
    "thunderstrikexkbot", "venomouslionkbot"
  ];
