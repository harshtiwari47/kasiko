...
export default {
  ...
  execute: async (args, message) => {
    try {
      ...
      const texts = [
        "gave a warm and comforting hold! 🤗",
        "wrapped them in a gentle hug! 💞",
        "offered a loving embrace! ❤️",
        "shared a tender moment with a warm hold! 🥰",
        "gave a reassuring hug! 💕",
        "held on tightly with love! 💓",
        "shared a heartfelt embrace! 🌟",
        "gave a supportive and caring hold! 👐",
        "offered a cozy hug! 🛋️",
        "wrapped them in a protective hold! 🛡️"
      ];
